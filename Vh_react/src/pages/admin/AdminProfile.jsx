...
function AdminProfile() {
    ...
    return (
        <div className="flex justify-center items-center h-full w-full h-[100vh]  bg-gradient-to-br from-[#1c202c] to-[#283046] flex justify-between">
            <Sidebar/>
            <div className="w-full h-full flex justify-center items-center">
            <div className="bg-[#2a2d3e] text-white  rounded-lg shadow-lg  w-full h-[100vh] border border-gray-700 ">
